...
### ------------------------------------CLASS-----------------------------------------
class STPTrainer():
    def __init__(self, stp_domain, verbosity, gui=False, infile=None, outfile=None, switch_label=None, port=None, option=None, test=False):
